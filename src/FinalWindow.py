...
import RainProbability 
import FinalBayesian
...
def get_weather_forecast():
    ...
    RainProbability.calculate_rain_probabilities(target_month, target_hour)
    FinalBayesian.calculate_bayesian_network(target_month, target_hour)
...
if __name__ == "__main__":
    # Call the functions when the script is run directly
    FinalBayesian.calculate_bayesian_network()
    RainProbability.calculate_rain_probabilities()
